...
public partial class Index
{
    ...
    private async Task FilterSuggestions()
    {
        ...
        {
            output = output.Where(o => o.Suggestion.Contains(searchText, StringComparison.InvariantCultureIgnoreCase) || o.Description.Contains(searchText, StringComparison.InvariantCultureIgnoreCase)).ToList();
        }
        ...
        {
            output = output.OrderByDescending(o => o.UserVotes.Count).ThenByDescending(o => o.DateCreated).ToList();
        }
    ...
    {
        archivingSuggestion.IsArchived = true;
